...
public class JMRConstants {
    ...
    public static final int MAP_TASK_MONITOR_SLEEP_MS = 1 * KMS; // 2 seconds
    public static final int MAP_TASK_SCHEDULER_SLEEP_MS = 1 * KMS; // 2 seconds
    public static final int REDUCE_TASK_MONITOR_SLEEP_MS = 10; // 2 seconds
